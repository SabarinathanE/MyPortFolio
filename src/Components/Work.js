      ...
      <div className="flex justify-between pt-2">
        <div className="flex flex-col md:flex-row">
          <div className="flex items-center pr-5">
            ...
            <p className="text-content text-xs md:text-sm  pl-1" style={{fontSize:"16px"}}>{company}</p>
          </div>
          <div className="flex items-center">
            ...
            <p className="text-content text-xs md:text-sm  pl-1" style={{fontSize:"16px"}}>{location}</p>
          </div>
        </div>
        <p className="text-content text-xs md:text-sm  pl-1 min-w-fit" style={{fontSize:"16px"}}>{duration}</p>
      </div>
    </article>
  );
}
