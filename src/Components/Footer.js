  ...
  return (
    ...
    <footer className="container mx-auto py-2 fixed bottom-0 md:left-15 bg-white dark:bg-dark-mode">
      ...
      <a href={linkdein} target="_blank" rel="noreferrer noopener">
        ...
        <li className="pb-1 md:pb-0" style={{color:"white"}}>LinkedIn</li>
        <li className="pb-1 md:pb-0">
        <a className="footer-img" href={github} target="_blank" rel="noreferrer noopener">
              <svg
                className="dark:fill-light-heading fill-dark-heading"
                width="30"
                height="30"
        ...
        <li className="pb-1 md:pb-0" style={{color:"white"}}>GitHub</li>
        </ul>
    </footer>
  );
}
